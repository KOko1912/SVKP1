...
const FeatureCard = ({ icon, title, description, index }) => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div className="feature-icon-background">
          {icon}
        </motion.div>
      </motion.div>
  ...
  const features = [
    {
      ...
      description: "Control absoluto sobre cada aspecto de tu tienda virtual con nuestro editor intuitivo. Cambia colores, imágenes y posiciones de productos con arrastrar y soltar."
    },
    {
      icon: <FiMessageSquare size={24} />,
      title: "WhatsApp Integrado",
      description: "Conecta directamente con tus clientes mediante integración nativa con WhatsApp Business. Recibe notificaciones y gestiona conversaciones desde un solo lugar."
    },
    {
      icon: <FiBarChart2 size={24} />,
      title: "Analytics Avanzados",
      description: "Toma decisiones basadas en datos en tiempo real con nuestro dashboard de analytics. Monitorea ventas, tráfico y comportamiento de clientes."
    },
    {
      icon: <FiShoppingCart size={24} />,
      title: "Gestión de Productos",
      description: "Administra tu inventario con facilidad. Destaca productos importantes y reorganiza tu catálogo con simples movimientos táctiles."
    },
    {
      icon: <FiDollarSign size={24} />,
      title: "Finanzas Completas",
      description: "Sistema integral de gestión financiera con reportes detallados de ingresos, gastos y proyecciones de crecimiento para tu negocio."
    },
    {
      icon: <FiUsers size={24} />,
      title: "Multiplan Flexible",
      description: "El usuario elige: comprador o vendedor. Planes desde $356 MXN mensuales con todas las funcionalidades profesionales para vender en línea."
    }
  ];
...
// Componente de Value Proposition
const ValueSection = () => {
  return (
...
function App() {
  ...
  // Cerrar menú al cambiar tamaño de ventana (responsive)
  useEffect(() => {
    const handleResize = () => {
